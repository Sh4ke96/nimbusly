...
import { APP_MOBILE_FULLSCREEN_OVERLAY_Z } from "@/lib/ui/app-layout";
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        ...
        overlayClassName={APP_MOBILE_FULLSCREEN_OVERLAY_Z}
        className={cn(
          APP_MOBILE_FULLSCREEN_OVERLAY_Z,
          "h-full w-full max-w-full gap-0 rounded-none p-0"
        )}
      >
