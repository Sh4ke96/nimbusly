  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "nimbus-toast group-[.toaster]:rounded-none group-[.toaster]:border group-[.toaster]:border-border group-[.toaster]:bg-card group-[.toaster]:text-card-foreground group-[.toaster]:font-sans group-[.toaster]:text-sm group-[.toaster]:shadow-sm group-[.toaster]:ring-1 group-[.toaster]:ring-border group-[.toaster]:items-center data-[type=success]:group-[.toaster]:border-primary/30 data-[type=success]:group-[.toaster]:bg-primary/10 data-[type=error]:group-[.toaster]:border-destructive/30 data-[type=error]:group-[.toaster]:bg-destructive/10",
          ...
          cancelButton:
            "group-[.toast]:rounded-none group-[.toast]:border group-[.toast]:border-border group-[.toast]:bg-background group-[.toast]:font-semibold group-[.toast]:text-foreground group-[.toast]:hover:bg-muted",
          closeButton:
