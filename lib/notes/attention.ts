...
export function isNoteMarkedUrgent(note: Pick<Note, "title" | "is_pinned">): boolean {
  return note.is_pinned === true || note.title.trimStart().startsWith(NOTE_ATTENTION_TITLE_PREFIX);
}
